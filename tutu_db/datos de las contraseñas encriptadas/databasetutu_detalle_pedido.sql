...
CREATE TABLE `detalle_pedido` (
  ...
  KEY `fk_detalle_pedido_productos1_idx` (`productos_idproductos`),
  ...
  CONSTRAINT `fk_detalle_pedido_productos1` FOREIGN KEY (`productos_idproductos`) REFERENCES `productos` (`idproductos`)
